...
#
rd_spinr_cfar_float_kernel = cp.RawKernel(
"""
//cuda
extern "C" __global__
void rd_spinr_cfar_float_kernel(
    ...
    for (int chirp = 0; chirp < n_chirps; ++chirp) {
        ...
        for (int t = 0; t < n_samples; ++t) {
            ...
            //if ((sample_idx == n_timesteps-1) && (gradient < 1.0f)) {
            ...
            if (sample_idx > t_grd) {
                ...
                //gradient = fmaxf(gradient, 0.001f); // ReLU
            }
...
""",
    name="rd_spinr_cfar_float_kernel",
)